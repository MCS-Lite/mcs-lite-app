...
export const retrievePrototype = id =>
  (dispatch, getState) =>
    request(
      `/prototypes/${id}`,
      'GET',
...
export const createTestDevice = data =>
  (dispatch, getState) =>
    request(
      '/devices',
      'POST',
...
export const createDataChannel = (id, data) =>
  (dispatch, getState) =>
    request(
...
export const deleteDataChannel = (id, dataChannelId) =>
  (dispatch, getState) =>
    request(
      `/prototypes/${id}/datachannels/${dataChannelId}`,
      'DELETE',
...
export const retrieveUnitTypes = () =>
  (dispatch, getState) =>
...
export const createUnitTypes = ({ name, symbol }) =>
  (dispatch, getState) =>
    request(
      '/unittypes',
      'POST',
