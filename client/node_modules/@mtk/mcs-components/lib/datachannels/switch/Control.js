...
var control = function control(_ref) {
  ...
  return _react2['default'].createElement('div', { className: (0, _classnames2['default'])(_commonCardStylesBaseCss2['default'].base, _commonCardStylesBaseCss2['default'][displayType], _stylesMainCss2['default'].base) });
};
...
exports['default'] = (0, _recompose.compose)((0, _recompose.defaultProps)({
  status: 0,
  displayType: 'none'
}), (0, _recompose.setPropTypes)(propTypes), _recompose.pure)(control);