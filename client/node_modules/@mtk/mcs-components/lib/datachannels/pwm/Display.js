...
var display = function display(_ref) {
  ...
  return _react2['default'].createElement(
    'div',
    { className: (0, _classnames2['default'])(_commonCardStylesBaseCss2['default'].base, _commonCardStylesBaseCss2['default'][displayType], _stylesMainCss2['default'].base) },
    _react2['default'].createElement(
      'ul',
      { className: _stylesMainCss2['default'].list },
      _react2['default'].createElement(
        'li',
        null,
        _react2['default'].createElement(
          'div',
          { className: _stylesMainCss2['default'].title },
          'Value'
        ),
        _react2['default'].createElement(
          'div',
          { className: _stylesMainCss2['default'].value },
          status.value
        )
      ),
      _react2['default'].createElement(
...
exports['default'] = (0, _recompose.compose)((0, _recompose.defaultProps)({
  status: { value: 0, period: 0 },
  displayType: 'none'
}), (0, _recompose.setPropTypes)(propTypes), _recompose.pure)(display);