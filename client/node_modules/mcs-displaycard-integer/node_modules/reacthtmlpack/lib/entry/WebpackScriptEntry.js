...
var WebpackScriptEntry = (function (_Component) {
  _inherits(WebpackScriptEntry, _Component);

  function WebpackScriptEntry() {
    _classCallCheck(this, WebpackScriptEntry);

    _get(Object.getPrototypeOf(WebpackScriptEntry.prototype), "constructor", this).apply(this, arguments);
  }

  _createClass(WebpackScriptEntry, [{
    key: "render",
    value: function render() {
      ...
      if (outputAssetList) {
        (0, _fbjsLibInvariant2["default"])(0 < outputAssetList.length, "[WebpackScriptEntry] outputAssetList is an empty array");

        var jsAssetList = outputAssetList.filter(function (_ref) {
          var publicFilepath = _ref.publicFilepath;

          (0, _fbjsLibInvariant2["default"])("string" === typeof publicFilepath, "[WebpackScriptEntry] publicFilepath (%s) is not a string", publicFilepath);

          return (/\.js$/.test(publicFilepath)
          );
        });
        (0, _fbjsLibInvariant2["default"])(0 < jsAssetList.length, "[WebpackScriptEntry] jsAssetList is an empty array. outputAssetList is [{publicFilepath: %s}]", outputAssetList[0].publicFilepath);

        var firstAsset = jsAssetList[0];

        return _react2["default"].createElement("script", _extends({}, restProps, { src: firstAsset.publicFilepath }));
      } else {
  ...
  return WebpackScriptEntry;
})(_react.Component);

exports["default"] = WebpackScriptEntry;
