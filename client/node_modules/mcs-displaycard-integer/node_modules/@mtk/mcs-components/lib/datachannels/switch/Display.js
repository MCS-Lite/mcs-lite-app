...
var display = function display(_ref) {
  ...
  return _react2['default'].createElement(
    'div',
    { className: (0, _classnames2['default'])(_commonCardStylesBaseCss2['default'].base, _commonCardStylesBaseCss2['default'][displayType], _stylesMainCss2['default'].displayBase) },
    format.map(function (key, index) {
      return _react2['default'].createElement(_commonKeyValueElement2['default'], _extends({ key: index }, key, { className: _stylesMainCss2['default'].key }));
    })
  );
};
